{
 "cells": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 17,
   "id": "081ec5cf-6e07-4e2d-b0aa-c677ff8057d6",
   "metadata": {},
   "outputs": [
    {
     "ename": "NameError",
     ...
     "traceback": [
      ...
      "Cell \u001b[1;32mIn[17], line 2\u001b[0m\n\u001b[0;32m      1\u001b[0m \u001b[38;5;66;03m# Analyzing the correlation matrix to extract insights regarding relationships between subjects\u001b[39;00m\n\u001b[1;32m----> 2\u001b[0m correlation_insights \u001b[38;5;241m=\u001b[39m correlation_matrix\u001b[38;5;241m.\u001b[39mto_dict()\n\u001b[0;32m      3\u001b[0m correlation_insights\n",
      "\u001b[1;31mNameError\u001b[0m: name 'correlation_matrix' is not defined"
     ]
    }
   ],
   "source": [
    "# Analyzing the correlation matrix to extract insights regarding relationships between subjects\n",
    "correlation_insights = correlation_matrix.to_dict()\n",
